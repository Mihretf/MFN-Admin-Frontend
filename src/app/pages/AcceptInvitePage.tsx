...
export function AcceptInvitePage() {
  ...
  const handleAcceptInvite = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use the user from response.data
      ...
      toast.error(error.response?.data?.message || 'Failed to accept invitation. Please check your invitation token.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            ...
            <CardDescription>Enter your details to accept the invitation and access your regional admin account</CardDescription>
          </div>
        </CardHeader>
        <CardContent>
